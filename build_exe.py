...
def gerar_executavel():
    ...
    comando = [
        ...
        "--name=GeradorEvidencias",     # Nome do executável
# "--icon=icon.ico",              # Ícone (se existir)
        "--add-data=processador_documentos.py;.",  # Incluir módulo
        "gerador_evidencias.py"         # Arquivo principal
    ]
    
    try:
        subprocess.run(comando, check=True)
        print("Executavel gerado com sucesso!")
        print("Localizacao: dist/GeradorEvidencias.exe")
...
if __name__ == "__main__":
    print("Gerador de Evidencias - Build para Windows")
    print("=" * 50)
    ...
    print("\nBuild concluido!")
    print("Execute: dist/GeradorEvidencias.exe")